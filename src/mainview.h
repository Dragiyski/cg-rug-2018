...
private:
    ...
    std::map<std::string, std::shared_ptr<Mesh>> namedMeshMap;
...
public:
    ...
    void setLockObject(QString name);
...
protected:
    ...
    std::shared_ptr<Mesh> addMesh(QString objFile, QString textureFile, Illumination illumination);
...
signals:
    ...
    void namedMeshAdded(const QString &names);
